...
// set the PDO error mode to exception
    ...
    // our SQL statememtns
    $conn->exec("INSERT INTO {$_POST['select']}_events values(id,'{$_POST['select']}','{$_POST['name_event']}','{$_POST['conducted_by']}','{$_POST['registration_detail']}','{$_POST['fee']}','{$_POST['time1']}','{$_POST['date']}','{$_POST['venue']}','{$_POST['time2']}')");
