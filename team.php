...
<?php 
	...
	$results = $db -> query("select id,category,description,link_to_table,teampic,teampic1 from main_category");
        ...
        // $qry = "select category,description,link_to_table,teampic,teampic1 from main_category;";
...
<div class="container-fluid">
			...
			<?php 	foreach ($categories as $id => $category) { ?>
					...
					<center><ol class="breadcrumb"><li><?php echo $categories[$id]["category"]?></li> HEAD</ol></center>
					<center><img src="img/team/<?php echo $categories[$id]["teampic1"] ?>" class="img-circle"/></center>
                <br>
				<br>
			        </div>
					<?php } ?>
